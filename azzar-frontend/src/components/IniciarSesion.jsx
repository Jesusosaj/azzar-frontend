...
function IniciarSesion({ onClose }) {
  ...
  const iniciarSesion = async (e) => {
    ...
    try {
      ...
      const response = await fetch("https://192.168.100.91:8080/v1/azzar/clientes/login", {
        method: "POST",
  ...
  const enviarCorreo = async (e) =>{
    ...
    setLoading(true);
    try {
      const response = await fetch("https://192.168.100.91:8080/v1/azzar/clientes/enviar-correo", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
  ...
  const cambiarPassword = async (e) => {
    ...
    try {
      ...
      const response = await fetch("https://192.168.100.91:8080/v1/azzar/clientes/cambiar/password", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify(usuario)
      });
